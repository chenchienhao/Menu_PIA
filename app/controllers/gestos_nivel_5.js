...
var imagen_globo = Ti.UI.createImageView({  //carga imagen a descifrar
    image: '/images/gestos/perdon2.png',
    backgroundColor:'white',
    top:"15%",
	left:"0%",
	height:'75%',
...
{
	if(indice[0]=='11'){
		/*	Ti.App.Properties.removeProperty("HS_gestos5");
		Ti.App.info(Ti.App.Properties.getBool("HS_gestos6", true));*/
		
		win1.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("HS_gestos5");
		Ti.App.Properties.setBool("HS_gestos5",true);
		
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("HS_gestos6") == 'true'){*/
			juego1=Alloy.createController('gestos_nivel_6');
		/*}else{
		...
		if(indice[0]=='1' && intentos<1){
			...
			if(indice[0]=='9' && intentos<1){
				...
				if(indice[0]=='13' && intentos<1){
					...
					juego4=Alloy.createController('gestos_nivel_5');
				}
			}
		}
	}
