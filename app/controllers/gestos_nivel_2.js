...
var imagen_globo = Ti.UI.createImageView({  //carga imagen a descifrar
    image: '/images/gestos/felizcumple.png',
    backgroundColor:'white',
    top:"15%",
	left:"0%",
	height:'75%',
...
{
	if(indice[0]=='7'){
		/*	Ti.App.Properties.removeProperty("HS_gestos2");
		Ti.App.info(Ti.App.Properties.getBool("HS_gestos3", true));*/
		
		win0.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("HS_gestos2");
		Ti.App.Properties.setBool("HS_gestos2",true);
		
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("HS_gestos3") == 'true'){*/
			juego1=Alloy.createController('gestos_nivel_3');
		/*}else{
