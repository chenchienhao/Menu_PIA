...
var sonido = Ti.Media.createSound({url:"/images/encabezados/colorea_miedo.m4a"});

var encabezado = Ti.UI.createImageView({
 	image: '/images/encabezados/colorea_miedo.png',
 	top: '2%', 
 	left: '15%',
	width: '70%',
	height: '10%'
...
amarillo.addEventListener('start', function(e){
	Ti.API.info('-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-');
...
amarillo.addEventListener('move', function(e){
	Ti.API.info('-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-');
...
amarillo.addEventListener('end', function(e){
	...
	alto = Titanium.Platform.displayCaps.platformHeight;
			...
			if(image1.id == '/images/colorear/miedo/miedo'){
			...
			if(image2.id == '/images/colorear/miedo/miedo'){
				var p = {x: e.left, y: e.top};
			...
			if(image3.id == '/images/colorear/miedo/miedo'){
				var p = {x: e.left, y: e.top};
    			var tp = win.convertPointToView(p, image3);
    			
    			if((-0.02*ancho)<=tp.x && tp.x<=(0.15*ancho) && (-0.10*alto)<=tp.y && tp.y<=(0.20*alto)){
					image3.backgroundColor="yellow";
					mensaje = 1;
				}
			}
			
			if(image4.id == '/images/colorear/miedo/miedo'){
				var p = {x: e.left, y: e.top};
    			var tp = win.convertPointToView(p, image4);
    			
    			if((-0.02*ancho)<=tp.x && tp.x<=(0.15*ancho) && (-0.10*alto)<=tp.y && tp.y<=(0.20*alto)){
					image4.backgroundColor="yellow";
					mensaje = 1;
				}
			}
			
			if(image5.id == '/images/colorear/miedo/miedo'){
				var p = {x: e.left, y: e.top};
    			var tp = win.convertPointToView(p, image5);
    			
    			if((-0.02*ancho)<=tp.x && tp.x<=(0.15*ancho) && (-0.10*alto)<=tp.y && tp.y<=(0.20*alto)){
					image5.backgroundColor="yellow";
					mensaje = 1;
				}
			}
			
			if(image6.id == '/images/colorear/miedo/miedo'){
				var p = {x: e.left, y: e.top};
    			var tp = win.convertPointToView(p, image6);
    			
    			if((-0.02*ancho)<=tp.x && tp.x<=(0.15*ancho) && (-0.10*alto)<=tp.y && tp.y<=(0.20*alto)){
					image6.backgroundColor="yellow";
					mensaje = 1;
				}
			}
			
			if(image7.id == '/images/colorear/miedo/miedo'){
				var p = {x: e.left, y: e.top};
    			var tp = win.convertPointToView(p, image7);
    			
    			if((-0.02*ancho)<=tp.x && tp.x<=(0.15*ancho) && (-0.10*alto)<=tp.y && tp.y<=(0.20*alto)){
					image7.backgroundColor="yellow";
					mensaje = 1;
				}
			}
			
			if(image8.id == '/images/colorear/miedo/miedo'){
				var p = {x: e.left, y: e.top};
    			var tp = win.convertPointToView(p, image8);
    			
    			if((-0.02*ancho)<=tp.x && tp.x<=(0.15*ancho) && (-0.10*alto)<=tp.y && tp.y<=(0.20*alto)){
					image8.backgroundColor="yellow";
					mensaje = 1;
				}
			}
			...
			if(mensaje == 1){
				...
				amarillo.setLeft('85%');
				if(logrados == 2){
					colorea_nivel_6 = Alloy.createController('colorea_nivel_6');
			...
			if(intentos>=4){
				colorea_nivel_5 = Alloy.createController('colorea_nivel_5');
			}
