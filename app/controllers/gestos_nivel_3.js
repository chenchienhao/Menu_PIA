...
var imagen_globo = Ti.UI.createImageView({  //carga imagen a descifrar
    image: '/images/gestos/buenos dias.png',
    backgroundColor:'white',
    top:"15%",
	left:"0%",
	height:'75%',
...
{
	if(indice[0]=='5'){
		/*	Ti.App.Properties.removeProperty("HS_gestos3");
		Ti.App.info(Ti.App.Properties.getBool("HS_gestos4", true));*/
		
		win1.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("HS_gestos3");
		Ti.App.Properties.setBool("HS_gestos3",true);
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("HS_gestos4") == 'true'){*/
			juego1=Alloy.createController('gestos_nivel_4');
		/*}else{
		...
		if(indice[0]=='1' && intentos<1){
			...
			if(indice[0]=='10' && intentos<1){
				...
				if(indice[0]=='13' && intentos<1){
					...
					//sonido.play();	
					juego2=Alloy.createController('gestos_nivel_3');
				}
			}
		}
	}
