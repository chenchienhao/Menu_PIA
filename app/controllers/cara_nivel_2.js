...
win.add(image8);
	...
	if(image1.id == '/images/cara/ojosasustado.png'){
			...
			if(image1.id == '/images/cara/bocaasustado.png'){
			image1.addEventListener('end', function(e){
	...
	if(image2.id == '/images/cara/ojosasustado.png'){
			...
			if(image2.id == '/images/cara/bocaasustado.png'){
				image2.addEventListener('end', function(e){
	...
	if(image3.id == '/images/cara/ojosasustado.png'){
		...
		if(image3.id == '/images/cara/bocaasustado.png'){
				image3.addEventListener('end', function(e){
	...
	if(image4.id == '/images/cara/ojosasustado.png'){
		...
		if(image4.id == '/images/cara/bocaasustado.png'){
				image4.addEventListener('end', function(e){
	...
	if(image5.id == '/images/cara/ojosasustado.png'){
		...
		if(image5.id == '/images/cara/bocaasustado.png'){
				image5.addEventListener('end', function(e){
	...
	if(image6.id == '/images/cara/ojosasustado.png'){
		...
		if(image6.id == '/images/cara/bocaasustado.png'){
				image6.addEventListener('end', function(e){
	...
	if(image7.id == '/images/cara/ojosasustado.png'){
		...
		if(image7.id == '/images/cara/bocaasustado.png'){
				image7.addEventListener('end', function(e){
	...
	if(image8.id == '/images/cara/ojosasustado.png'){
		...
		if(image8.id == '/images/cara/bocaasustado.png'){
				image8.addEventListener('end', function(e){
