...
var imagen_globo = Ti.UI.createImageView({  //carga imagen a descifrar
    image: '/images/gestos/buenas noches.png',
    backgroundColor:'white',
    top:"15%",
	left:"0%",
	height:'75%',
...
{
	if(indice[0]=='4'){
		/*	Ti.App.Properties.removeProperty("HS_gestos6");
		Ti.App.info(Ti.App.Properties.getBool("HS_gestos7", true));*/
		
		win1.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("HS_gestos6");
		Ti.App.Properties.setBool("HS_gestos6",true);
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("HS_gestos7") == 'true'){*/
			juego1=Alloy.createController('gestos_nivel_7');
		/*}else{
		...
		if(indice[0]=='7' && intentos<1){
			...
			if(indice[0]=='13' && intentos<1){
				...
				if(indice[0]=='14' && intentos<1){
					
					intentos=intentos+1;
				}
				else{
						
					juego5=Alloy.createController('gestos_nivel_6');
				}
			}
		}
	}
