...
var image11 = Ti.UI.createImageView({image: '/images/siluetas_imagen/simpsons5.png', left:'70%', top:'25%', width:'25%', height:'60%'});
...
image1.addEventListener('click',function(e){
   ...
   if(indice[0] == 5){
		...
		Ti.App.Properties.removeProperty("TF_siluetas5");
		Ti.App.Properties.setBool("TF_siluetas5",true);
    	setTimeout(function(){
			siluetas_nivel_5 = Alloy.createController('siluetas_nivel_6');
		},3000);
	}else{
		contador = contador + 1;
		if(contador >=5){
