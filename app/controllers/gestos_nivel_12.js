...
{
	if(indice[0]=='6'){
		/*	Ti.App.Properties.removeProperty("HS_gestos12");
		Ti.App.info(Ti.App.Properties.getBool("HS_gestos13", true));*/
		
		win1.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("HS_gestos12");
		Ti.App.Properties.setBool("HS_gestos12",true);
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("HS_gestos13") == 'true'){*/
			juego1=Alloy.createController('gestos_nivel_13');
		/*}else{
		...
		if(indice[0]=='1' && intentos<1){
			...
			if(indice[0]=='11' && intentos<1){
				...
				if(indice[0]=='13' && intentos<1){
					...
					juego11=Alloy.createController('gestos_nivel_12');
				}
			}
		}
	}
