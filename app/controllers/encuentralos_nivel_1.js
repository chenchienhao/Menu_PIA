...
var mensaje=1; //variable que cuenta cuantas veces se emite el mensaje de instrucciones por juego
/******************************************************************/
...
var imagen_fondo= Ti.UI.createImageView({  //carga imagen base
    image: '/images/pajaritos/imagen1.jpg',
    //backgroundColor:'white',
    top:"10%",
	left:"5%",
	//right:'30%',
...
function nuevo_nivel(vidas){
	if(vidas==6){
		/*	Ti.App.Properties.removeProperty("TF_encuentralos1");
		Ti.App.info(Ti.App.Properties.getBool("TF_encuentralos2", true));*/
		
		win0.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("TF_encuentralos1");
		Ti.App.Properties.setBool("TF_encuentralos1",true);	
		
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("TF_encuentralos2") == 'true'){*/
			juego1=Alloy.createController('encuentralos_nivel_2');
		/*}else{
