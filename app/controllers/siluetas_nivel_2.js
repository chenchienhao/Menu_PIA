...
var image11 = Ti.UI.createImageView({image: '/images/siluetas_imagen/simpsons2.png', left:'70%', top:'25%', width:'25%', height:'60%'});
...
image1.addEventListener('click',function(e){
   ...
   if(indice[0] == 2){
		...
		Ti.App.Properties.removeProperty("TF_siluetas2");
		Ti.App.Properties.setBool("TF_siluetas2",true);
    	setTimeout(function(){
			siluetas_nivel_2 = Alloy.createController('siluetas_nivel_3');
		},3000);
	}else{
		contador = contador + 1;
		if(contador >=5){
