...
var imagen_globo = Ti.UI.createImageView({  //carga imagen a descifrar
    image: '/images/gestos/por favor.png',
    backgroundColor:'white',
    top:"15%",
	left:"0%",
	height:'75%',
...
{
	if(indice[0]=='12'){
		/*	Ti.App.Properties.removeProperty("HS_gestos15");
		Ti.App.Properties.getBool("HS_gestos15", true));*/
		...
		if(indice[0]=='7' && intentos<1){
			...
			if(indice[0]=='10' && intentos<1){
				...
				if(indice[0]=='14' && intentos<1){
					...
					juego14=Alloy.createController('gestos_nivel_15');
				}
			}
		}
	}
