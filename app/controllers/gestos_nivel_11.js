...
var imagen_globo = Ti.UI.createImageView({  //carga imagen a descifrar
    image: '/images/gestos/buenas tardes.png',
    backgroundColor:'white',
    top:"15%",
	left:"0%",
	height:'75%',
...
{
	if(indice[0]=='3'){
		/*	Ti.App.Properties.removeProperty("HS_gestos11");
		Ti.App.info(Ti.App.Properties.getBool("HS_gestos12", true));*/
		
		win1.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("HS_gestos11");
		Ti.App.Properties.setBool("HS_gestos11",true);
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("HS_gestos12") == 'true'){*/
			juego1=Alloy.createController('gestos_nivel_12');
		/*}else{
		...
		if(indice[0]=='6' && intentos<1){
			...
			if(indice[0]=='8' && intentos<1){
				...
				if(indice[0]=='10' && intentos<1){
					...
					juego10=Alloy.createController('gestos_nivel_11');
				}
			}
		}
	}
