...
{
	if(indice[0]=='2'){
		/*	Ti.App.Properties.removeProperty("HS_gestos14");
		Ti.App.info(Ti.App.Properties.getBool("HS_gestos15", true));*/
		
		win1.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("HS_gestos14");
		Ti.App.Properties.setBool("HS_gestos14",true);	
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("HS_gestos15") == 'true'){*/
			juego1=Alloy.createController('gestos_nivel_15');
		/*}else{
		...
		if(indice[0]=='4' && intentos<1){
			...
			if(indice[0]=='9' && intentos<1){
				...
				if(indice[0]=='13' && intentos<1){
					...
					juego13=Alloy.createController('gestos_nivel_14');
				}
			}
		}
	}
