...
win.add(image8);
	...
	if(image1.id == '/images/cara/ojosfeliz.png'){
			...
			alto = Titanium.Platform.displayCaps.platformHeight;
					...
					if(intentos>=4){
						cara_nivel_1 = Alloy.createController('cara_nivel_1');
					}
			...
			if(image1.id == '/images/cara/bocafeliz.png'){
			image1.addEventListener('end', function(e){
	...
	if(image2.id == '/images/cara/ojosfeliz.png'){
			...
			if(image2.id == '/images/cara/bocafeliz.png'){
				image2.addEventListener('end', function(e){
	...
	if(image3.id == '/images/cara/ojosfeliz.png'){
		...
		if(image3.id == '/images/cara/bocafeliz.png'){
				image3.addEventListener('end', function(e){
	...
	if(image4.id == '/images/cara/ojosfeliz.png'){
		...
		if(image4.id == '/images/cara/bocafeliz.png'){
				image4.addEventListener('end', function(e){
	...
	if(image5.id == '/images/cara/ojosfeliz.png'){
		...
		if(image5.id == '/images/cara/bocafeliz.png'){
				image5.addEventListener('end', function(e){
	...
	if(image6.id == '/images/cara/ojosfeliz.png'){
		...
		if(image6.id == '/images/cara/bocafeliz.png'){
				image6.addEventListener('end', function(e){
	...
	if(image7.id == '/images/cara/ojosfeliz.png'){
		...
		if(image7.id == '/images/cara/bocafeliz.png'){
				image7.addEventListener('end', function(e){
	...
	if(image8.id == '/images/cara/ojosfeliz.png'){
		...
		if(image8.id == '/images/cara/bocafeliz.png'){
				image8.addEventListener('end', function(e){
