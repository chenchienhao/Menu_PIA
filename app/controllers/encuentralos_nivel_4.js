...
var imagen_fondo= Ti.UI.createImageView({  //carga imagen base
    image: '/images/pajaritos/imagen4.jpg',
    backgroundColor:'white',
    top:"10%",
	left:"5%",
	//right:'30%',
...
function nuevo_nivel_aleatorio(intentos){
	if(intentos>2){
		juegop4=Alloy.createController('encuentralos_nivel_'+indice[0]+'');
	}
}
//funcion que pasa al siguiente nivel
function nuevo_nivel(vidas){
	if(vidas==6){
		/*	Ti.App.Properties.removeProperty("TF_encuentralos4");
		Ti.App.info(Ti.App.Properties.getBool("TF_encuentralos5", true));*/
		
		win0.add(gifView);
		//Desbloquear siguiente nivel.
		Ti.App.Properties.removeProperty("TF_encuentralos4");
		Ti.App.Properties.setBool("TF_encuentralos4",true);	
		setTimeout(function(){
		/*desbloquear sgte. nivel
		if(Ti.App.Properties.getBool("TF_encuentralos5") == 'true'){*/
			juego1=Alloy.createController('encuentralos_nivel_5');
		/*}else{
